...
REM
REM Generated by Vivado on Wed Mar 15 22:45:08 +0900 2023
...
echo "xvlog --incr --relax -prj tb_T_FF__vlog.prj"
call xvlog  --incr --relax -prj tb_T_FF__vlog.prj -log xvlog.log
