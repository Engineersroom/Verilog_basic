...
HD_PWD='C:/Users/MSI/Documents/Eunsang/Code/Verilog/Verilog_basic/T_FF/T_FF.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log T_FF_.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source T_FF_.tcl
