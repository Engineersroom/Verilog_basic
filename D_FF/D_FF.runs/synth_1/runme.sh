...
HD_PWD='C:/Users/MSI/Documents/Eunsang/Code/Verilog/Verilog_basic/D_FF/D_FF.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log D_FF_.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source D_FF_.tcl
